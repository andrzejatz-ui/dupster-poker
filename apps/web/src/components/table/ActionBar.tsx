        ...
        {(legal.canBet || legal.canRaise) && (
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-28 px-3 py-2 rounded-lg bg-ink-900/80 border border-white/10 text-neon-gold font-mono focus:border-neon-gold/60 focus:shadow-[0_0_18px_rgba(255,209,102,0.35)] outline-none"
            />
            <NeonButton
              variant="gold"
              onClick={() =>

...
const en = {
  ...
  'invite.subtitle': 'Send a private link via Telegram, WhatsApp, SMS — or copy it and paste anywhere.',
  'invite.native': 'Share…',
  'invite.nativeSub': 'Pick from all installed apps',
  'invite.viaTelegram': 'Open Telegram share sheet',
  'invite.viaWhatsApp': 'Send via WhatsApp',
  'invite.viaSms': 'Send via SMS',
  'invite.copyLink': 'Copy invite link',
  'invite.copied': 'Copied!',
  'invite.preview': 'Message preview',
  'invite.shareMessage':
...
const de: Record<keyof typeof en, string> = {
  ...
  'invite.subtitle': 'Privater Link via Telegram, WhatsApp, SMS — oder kopieren und überall einfügen.',
  'invite.native': 'Teilen…',
  'invite.nativeSub': 'Auswahl aus allen installierten Apps',
  'invite.viaTelegram': 'Telegram-Share-Sheet öffnen',
  'invite.viaWhatsApp': 'Per WhatsApp senden',
  'invite.viaSms': 'Per SMS senden',
  'invite.copyLink': 'Einladungs-Link kopieren',
  'invite.copied': 'Kopiert!',
  'invite.preview': 'Nachricht-Vorschau',
  'invite.shareMessage':
    '🎰 Komm zu Bluffuminati — privates Texas Hold\'em, Play-Money-Chips, invite-only.\n\nIn Telegram öffnen: {link}\nOder im Browser: {web}',
...
const pl: Record<keyof typeof en, string> = {
  ...
  'invite.subtitle': 'Wyślij prywatny link przez Telegram, WhatsApp, SMS — albo skopiuj i wklej gdzie chcesz.',
  'invite.native': 'Udostępnij…',
  'invite.nativeSub': 'Wybierz z dowolnej zainstalowanej aplikacji',
  'invite.viaTelegram': 'Otwórz okno udostępniania Telegram',
  'invite.viaWhatsApp': 'Wyślij przez WhatsApp',
  'invite.viaSms': 'Wyślij przez SMS',
  'invite.copyLink': 'Skopiuj link zaproszenia',
  'invite.copied': 'Skopiowano!',
  'invite.preview': 'Podgląd wiadomości',
  'invite.shareMessage':
    '🎰 Dołącz do mnie w Bluffuminati — prywatny Texas Hold\'em, żetony bez wartości, tylko z zaproszenia.\n\nOtwórz w Telegramie: {link}\nLub w przeglądarce: {web}',
